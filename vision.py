...
class shop:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Gamya Visions",font=("times new roman",20,"bold"),bg="white",fg="blue")
        ...
        orderno=Label(Manage_Frame,text="Order No:",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        date=Label(Manage_Frame,text="Order Date:",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        name=Label(Manage_Frame,text="Name:",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        phone=Label(Manage_Frame,text="Phone:",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        age=Label(Manage_Frame,text="Age:",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        gender=Label(Manage_Frame,text="Gender:",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        total=Label(Manage_Frame,text="Total:",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        amount=Label(Manage_Frame,text="Advance:",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        balance=Label(Manage_Frame,text="Balance:",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        ltype=Label(Manage_Frame,text="Lens Type:",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        ftype=Label(Manage_Frame,text="Frame Size:",bg="white",fg="blue",font=("times new roman",15,"bold"))
       ...
       # details 
        ...
        od=Label(pres1_Frame,text="O.D",bg="white",fg="blue",font=("times new roman",15,"bold"))
        od.grid(row=13,column=0,pady=4,sticky=W+N)

        os=Label(pres1_Frame,text="O.S",bg="white",fg="blue",font=("times new roman",15,"bold"))
        os.grid(row=14,column=0,pady=4,sticky=W+N)

        od=Label(pres1_Frame,text="sph",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        od=Label(pres1_Frame,text="cyl",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        od=Label(pres1_Frame,text="axis",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        od=Label(pres1_Frame,text="add",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        od=Label(pres1_Frame,text="pd",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        remarks=Label(Manage_Frame,text="Remarks:",bg="white",fg="blue",font=("times new roman",15,"bold"))
        ...
        save=Button(but_Frame,text="Add",command=self.add_customer,width=7,height=2,bg="orange").grid(row=1,column=0,padx=30,pady=30)
        ...
        export_data=Button(but_Frame,text="Export",width=7,height=2,bg="orange",command=self.export_data).grid(row=1,column=4,padx=30)
        ...
        self.Customer_table=ttk.Treeview(table_frame,columns=("OrderNo","Date","Name","Phone","Age","Gender","Total","Amount","Balance","Lens Type","Frame size","Remarks","sph1","sph2","cyl1","cyl2","axis1","axis2","add1","add2","pd1","pd2"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def create(self):
        ...
        cur=conn.cursor()
        cur.execute("create table customers (orderno TEXT,date TEXT,name TEXT,phone TEXT,age TEXT,gender TEXT,total TEXT,advance TEXT,balance TEXT,ltype TEXT,fsize TEXT,remarks TEXT,sph1 TEXT,sph2 TEXT,cyl1 TEXT,cyl2 TEXT,axis1 TEXT,axis2 TEXT2,add1 TEXT,add2 TEXT,pd1 TEXT,pd2 TEXT)")
        conn.commit()
    ...
    def  update_data(self):
        if self.Phone_var.get()=="" or self.Name_var.get()==""  or self.OrderNo_var.get()=="":
            ...
            conn=sqlite3.connect(db)
            cur=conn.cursor()
            cur.execute("update customers set orderno=?,date=?,name=?,phone=?,age=?,gender=?,total=?,advance=?,balance=?,ltype=?,fsize=?,remarks=?,sph1=?,sph2=?,cyl1=?,cyl2=?,axis1=?,axis2=?,add1=?,add2=?,pd1=?,pd2=?",(self.OrderNo_var.get(),self.Orderdate_var.get(),self.Name_var.get(),
    ...
    def export_data(self):
        if len(mydata)<1:
            ...
            return FALSE
        f=filedialog.asksaveasfilename(initialdir=os.getcwd(),title="Save CSV",filetypes=(("CSV file","*.csv"),("All files","*.*")))
        with open(f,mode='w') as customers_details:
            exp_writer=csv.writer(customers_details,delimiter=',')
            for i in mydata:
                exp_writer.writerow(i)
        messagebox.showinfo("Data exported","Your data has exported to"+os.path.basename(f)+"successfully")        
